-- CreateEnum
CREATE TYPE "FamilyRole" AS ENUM ('MASTER', 'MEMBER');
...
-- CreateIndex
CREATE UNIQUE INDEX "Project_familyId_key_key" ON "Project"("familyId", "key");
...
-- AddForeignKey
ALTER TABLE "Project" ADD CONSTRAINT "Project_familyId_fkey" FOREIGN KEY ("familyId") REFERENCES "Family"("id") ON DELETE CASCADE ON UPDATE CASCADE;
